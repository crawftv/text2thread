...
var $author$project$Main$Text = function (text) {
	return {text: text};
};
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Main$Paragraph = F2(
	function (depth, pre_cleaned_words) {
		return {depth: depth, pre_cleaned_words: pre_cleaned_words};
	});
...
var $author$project$Main$paragraphDecoder = A3(
	...
	A3(
		...
		$elm$json$Json$Decode$succeed($author$project$Main$Paragraph)));
var $author$project$Main$textDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'data',
	$elm$json$Json$Decode$list($author$project$Main$paragraphDecoder),
	$elm$json$Json$Decode$succeed($author$project$Main$Text));
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{text: $krisajenkins$remotedata$RemoteData$Loading},
		A4($ohanhi$remotedata_http$RemoteData$Http$getWithConfig, $ohanhi$remotedata_http$RemoteData$Http$defaultConfig, 'http://localhost:5000/api', $author$project$Main$HandleResponse, $author$project$Main$textDecoder));
};
			...
			return {
				body: _List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$layout,
						_List_Nil,
						$mdgriffith$elm_ui$Element$text('network error'))
					]),
				title: 'Network Error'
			};
		case 'BadStatus':
...
var $author$project$Main$edges = {bottom: 8, left: 4, right: 0, top: 8};
...
var $author$project$Main$viewParagraph = function (paragraph) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$width(
						$mdgriffith$elm_ui$Element$px(paragraph.depth * 100))
					]),
				$mdgriffith$elm_ui$Element$text('')),
				A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text(paragraph.pre_cleaned_words)
					]))
			]));
};
var $author$project$Main$viewText = function (text) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$Main$viewParagraph, text.text));
};
			...
			return {
				body: _List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$layout,
						_List_Nil,
						$author$project$Main$viewText(data))
					]),
				title: 'Home'
			};
		default:
